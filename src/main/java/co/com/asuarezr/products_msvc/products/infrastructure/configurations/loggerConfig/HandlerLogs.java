...
public class HandlerLogs {
  ...
  @Before("@annotation(co.com.asuarezr.products_msvc.products.domain.annotations.LogBefore)")
  ...
  @AfterReturning(pointcut = "@annotation(co.com.asuarezr.products_msvc.products.domain.annotations.LogAfter)")
  ...
  @AfterThrowing(pointcut = "@annotation(co.com.asuarezr.products_msvc.products.domain.annotations.LogExceptions)", throwing = "exception")
  ...
  @Around("@annotation(co.com.asuarezr.products_msvc.products.domain.annotations.LogTimer)")
